...
See [virtual-modules-errors-and-gotchas](https://github.com/TylorS/typed-smol/blob/main/packages/virtual-modules/.docs/virtual-modules-errors-and-gotchas.md) for full reference. Summary:
