...
| `tsconfig`                 | `string`                            | —                             | Path to `tsconfig.json` (relative to cwd or absolute). Used by the Language Service session. Default: auto-discovered from project root.                                                  |
| `tsconfigPaths`            | `boolean`                           | `true`                        | Enable Vite-native `resolve.tsconfigPaths`.                                                                                                                                               |
