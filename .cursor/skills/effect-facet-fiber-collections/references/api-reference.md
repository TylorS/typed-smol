...
export declare const runIn: (scope: Scope): <A, E>(self: Fiber<A, E>) => Fiber<A, E>; // overload 1
export declare const runIn: <A, E>(self: Fiber<A, E>, scope: Scope): Fiber<A, E>; // overload 2
```
