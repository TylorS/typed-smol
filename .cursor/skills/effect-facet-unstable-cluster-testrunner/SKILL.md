---
name: effect-facet-unstable-cluster-testrunner
description: Guidance for facet `effect/unstable/cluster/TestRunner` focused on APIs like layer. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/TestRunner

## Owned scope

- Owns only `effect/unstable/cluster/TestRunner`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/TestRunner.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/TestRunner.ts`
