---
name: effect-facet-unstable-cluster-runner
description: Guidance for facet `effect/unstable/cluster/Runner` focused on APIs like make and Runner. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/Runner

## Owned scope

- Owns only `effect/unstable/cluster/Runner`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/Runner.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/Runner.ts`
