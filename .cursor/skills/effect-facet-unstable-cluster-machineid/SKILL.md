---
name: effect-facet-unstable-cluster-machineid
description: Guidance for facet `effect/unstable/cluster/MachineId` focused on APIs like make and MachineId. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/MachineId

## Owned scope

- Owns only `effect/unstable/cluster/MachineId`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/MachineId.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/MachineId.ts`
