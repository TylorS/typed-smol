---
name: effect-facet-unstable-cluster-sharding
description: Guidance for facet `effect/unstable/cluster/Sharding` focused on APIs like layer and Sharding. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/Sharding

## Owned scope

- Owns only `effect/unstable/cluster/Sharding`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/Sharding.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/Sharding.ts`
