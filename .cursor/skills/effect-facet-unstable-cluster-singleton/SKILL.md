---
name: effect-facet-unstable-cluster-singleton
description: Guidance for facet `effect/unstable/cluster/Singleton` focused on APIs like make. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/Singleton

## Owned scope

- Owns only `effect/unstable/cluster/Singleton`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/Singleton.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/Singleton.ts`
