---
name: effect-facet-unstable-cluster-shardid
description: Guidance for facet `effect/unstable/cluster/ShardId` focused on APIs like make and ShardId. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/ShardId

## Owned scope

- Owns only `effect/unstable/cluster/ShardId`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/ShardId.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/ShardId.ts`
