---
name: effect-facet-unstable-cluster-deliverat
description: Guidance for facet `effect/unstable/cluster/DeliverAt` focused on APIs like isDeliverAt, symbol, and toMillis. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/DeliverAt

## Owned scope

- Owns only `effect/unstable/cluster/DeliverAt`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/DeliverAt.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/DeliverAt.ts`
