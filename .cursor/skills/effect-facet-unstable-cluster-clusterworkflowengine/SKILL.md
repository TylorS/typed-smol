---
name: effect-facet-unstable-cluster-clusterworkflowengine
description: Guidance for facet `effect/unstable/cluster/ClusterWorkflowEngine` focused on APIs like make and layer. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/ClusterWorkflowEngine

## Owned scope

- Owns only `effect/unstable/cluster/ClusterWorkflowEngine`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/ClusterWorkflowEngine.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/ClusterWorkflowEngine.ts`
