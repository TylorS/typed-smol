---
name: effect-facet-unstable-http-template
description: Guidance for facet `effect/unstable/http/Template` focused on APIs like make, Error, and stream. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/Template

## Owned scope

- Owns only `effect/unstable/http/Template`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/Template.ts`.
...
- Facet source: `packages/effect/src/unstable/http/Template.ts`
