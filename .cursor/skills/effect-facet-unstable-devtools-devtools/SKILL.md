---
name: effect-facet-unstable-devtools-devtools
description: Guidance for facet `effect/unstable/devtools/DevTools` focused on APIs like layer, layerSocket, and layerWebSocket. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/devtools/DevTools

## Owned scope

- Owns only `effect/unstable/devtools/DevTools`.
- Parent module: `effect/unstable/devtools`.
- Source anchor: `packages/effect/src/unstable/devtools/DevTools.ts`.
...
- Facet source: `packages/effect/src/unstable/devtools/DevTools.ts`
