---
name: effect-facet-unstable-cluster-message
description: Guidance for facet `effect/unstable/cluster/Message` focused on APIs like Incoming and Outgoing. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/Message

## Owned scope

- Owns only `effect/unstable/cluster/Message`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/Message.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/Message.ts`
