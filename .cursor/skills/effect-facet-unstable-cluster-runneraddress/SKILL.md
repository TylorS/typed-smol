---
name: effect-facet-unstable-cluster-runneraddress
description: Guidance for facet `effect/unstable/cluster/RunnerAddress` focused on APIs like make and RunnerAddress. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/RunnerAddress

## Owned scope

- Owns only `effect/unstable/cluster/RunnerAddress`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/RunnerAddress.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/RunnerAddress.ts`
