---
name: effect-facet-unstable-http-multipart
description: Guidance for facet `effect/unstable/http/Multipart` focused on APIs like makeConfig, makeChannel, and isFile. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/Multipart

## Owned scope

- Owns only `effect/unstable/http/Multipart`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/Multipart.ts`.
...
- Facet source: `packages/effect/src/unstable/http/Multipart.ts`
