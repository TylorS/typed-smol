...
- Facet import: `effect/unstable/workflow/WorkflowProxyServer`
- Parent module: `effect/unstable/workflow`
- Facet skill: `effect-facet-unstable-workflow-workflowproxyserver`
- Source: `packages/effect/src/unstable/workflow/WorkflowProxyServer.ts`
- Parent primary skill: `effect-module-unstable-workflow`
