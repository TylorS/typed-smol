# API Reference: effect/Layer#building

- Import path: `effect/Layer#building`
- Source file: `packages/effect/src/Layer.ts`
- Thematic facet: `building`
...
export declare const effect: <I, S>(service: Context.Service<I, S>): <E, R>(effect: Effect<S, E, R>) => Layer<I, E, Exclude<R, Scope.Scope>>; // overload 1
export declare const effect: <I, S, E, R>(service: Context.Service<I, S>, effect: Effect<S, E, R>): Layer<I, E, Exclude<R, Scope.Scope>>; // overload 2
export declare const effectDiscard: <X, E, R>(effect: Effect<X, E, R>): Layer<never, E, Exclude<R, Scope.Scope>>;
export declare const effectServices: <A, E, R>(effect: Effect<Context.Context<A>, E, R>): Layer<A, E, Exclude<R, Scope.Scope>>;
...
export declare const mock: <I, S extends object>(service: Context.Service<I, S>): (implementation: PartialEffectful<S>) => Layer<I>;
...
export declare const sync: <I, S>(service: Context.Service<I, S>): (evaluate: LazyArg<S>) => Layer<I>; // overload 1
export declare const sync: <I, S>(service: Context.Service<I, S>, evaluate: LazyArg<S>): Layer<I>; // overload 2
export declare const syncServices: <A>(evaluate: LazyArg<Context.Context<A>>): Layer<A>;
export declare const unwrap: <A, E1, R1, E, R>(self: Effect<Layer<A, E1, R1>, E, R>): Layer<A, E | E1, R1 | Exclude<R, Scope.Scope>>;
export declare const updateService: <I, A>(service: Context.Service<I, A>, f: (a: A) => A): <A1, E1, R1>(layer: Layer<A1, E1, R1>) => Layer<A1, E1, I | R1>; // overload 1
export declare const updateService: <A1, E1, R1, I, A>(layer: Layer<A1, E1, R1>, service: Context.Service<I, A>, f: (a: A) => A): Layer<A1, E1, I | R1>; // overload 2
