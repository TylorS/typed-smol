...
- Facet import: `effect/unstable/cluster/EntityProxyServer`
- Parent module: `effect/unstable/cluster`
- Facet skill: `effect-facet-unstable-cluster-entityproxyserver`
- Source: `packages/effect/src/unstable/cluster/EntityProxyServer.ts`
- Parent primary skill: `effect-module-unstable-cluster`
