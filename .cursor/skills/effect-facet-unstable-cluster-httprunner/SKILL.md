---
name: effect-facet-unstable-cluster-httprunner
description: Guidance for facet `effect/unstable/cluster/HttpRunner` focused on APIs like layerHttp, layerClient, and layerClientProtocolHttp. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/HttpRunner

## Owned scope

- Owns only `effect/unstable/cluster/HttpRunner`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/HttpRunner.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/HttpRunner.ts`
