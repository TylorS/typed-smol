---
name: effect-facet-unstable-cluster-socketrunner
description: Guidance for facet `effect/unstable/cluster/SocketRunner` focused on APIs like layer and layerClientOnly. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/SocketRunner

## Owned scope

- Owns only `effect/unstable/cluster/SocketRunner`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/SocketRunner.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/SocketRunner.ts`
