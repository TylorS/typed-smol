---
name: effect-facet-unstable-http-httpclientresponse
description: Guidance for facet `effect/unstable/http/HttpClientResponse` focused on APIs like fromWeb, filterStatus, and filterStatusOk. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpClientResponse

## Owned scope

- Owns only `effect/unstable/http/HttpClientResponse`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpClientResponse.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpClientResponse.ts`
