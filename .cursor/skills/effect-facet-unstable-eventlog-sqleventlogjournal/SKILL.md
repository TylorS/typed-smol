---
name: effect-facet-unstable-eventlog-sqleventlogjournal
description: Guidance for facet `effect/unstable/eventlog/SqlEventLogJournal` focused on APIs like make and layer. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/eventlog/SqlEventLogJournal

## Owned scope

- Owns only `effect/unstable/eventlog/SqlEventLogJournal`.
- Parent module: `effect/unstable/eventlog`.
- Source anchor: `packages/effect/src/unstable/eventlog/SqlEventLogJournal.ts`.
...
- Facet source: `packages/effect/src/unstable/eventlog/SqlEventLogJournal.ts`
