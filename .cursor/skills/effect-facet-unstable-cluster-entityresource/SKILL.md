---
name: effect-facet-unstable-cluster-entityresource
description: Guidance for facet `effect/unstable/cluster/EntityResource` focused on APIs like make, makeK8sPod, and TypeId. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/EntityResource

## Owned scope

- Owns only `effect/unstable/cluster/EntityResource`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/EntityResource.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/EntityResource.ts`
