---
name: effect-facet-unstable-cluster-snowflake
description: Guidance for facet `effect/unstable/cluster/Snowflake` focused on APIs like make, Generator, and makeGenerator. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/Snowflake

## Owned scope

- Owns only `effect/unstable/cluster/Snowflake`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/Snowflake.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/Snowflake.ts`
