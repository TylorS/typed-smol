---
name: effect-facet-unstable-cluster-runnerserver
description: Guidance for facet `effect/unstable/cluster/RunnerServer` focused on APIs like layer, layerHandlers, and layerClientOnly. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/RunnerServer

## Owned scope

- Owns only `effect/unstable/cluster/RunnerServer`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/RunnerServer.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/RunnerServer.ts`
