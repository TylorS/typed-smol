...
export declare const provideEffect: <I, S, Input, R2, E2>(service: Context.Service<I, S>, effect: Effect.Effect<S, E2, R2> | ((input: Input) => Effect.Effect<S, E2, R2>)): <const Name extends string, E, R>(self: Command<Name, Input, E, R>) => Command<Name, Input, E | E2, Exclude<R, I> | R2>; // overload 1
export declare const provideEffect: <const Name extends string, Input, E, R, I, S, R2, E2>(self: Command<Name, Input, E, R>, service: Context.Service<I, S>, effect: Effect.Effect<S, E2, R2> | ((input: Input) => Effect.Effect<S, E2, R2>)): Command<Name, Input, E | E2, Exclude<R, I> | R2>; // overload 2
...
export declare const provideSync: <I, S, Input>(service: Context.Service<I, S>, implementation: S | ((input: Input) => S)): <const Name extends string, E, R>(self: Command<Name, Input, E, R>) => Command<Name, Input, E, Exclude<R, I>>; // overload 1
export declare const provideSync: <const Name extends string, Input, E, R, I, S>(self: Command<Name, Input, E, R>, service: Context.Service<I, S>, implementation: S | ((input: Input) => S)): Command<Name, Input, E, Exclude<R, I>>; // overload 2
