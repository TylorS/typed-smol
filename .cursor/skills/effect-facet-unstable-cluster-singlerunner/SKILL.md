---
name: effect-facet-unstable-cluster-singlerunner
description: Guidance for facet `effect/unstable/cluster/SingleRunner` focused on APIs like layer. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/SingleRunner

## Owned scope

- Owns only `effect/unstable/cluster/SingleRunner`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/SingleRunner.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/SingleRunner.ts`
