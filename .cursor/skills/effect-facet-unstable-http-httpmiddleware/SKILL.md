---
name: effect-facet-unstable-http-httpmiddleware
description: Guidance for facet `effect/unstable/http/HttpMiddleware` focused on APIs like make, layerTracerDisabledForUrls, and cors. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpMiddleware

## Owned scope

- Owns only `effect/unstable/http/HttpMiddleware`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpMiddleware.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpMiddleware.ts`
