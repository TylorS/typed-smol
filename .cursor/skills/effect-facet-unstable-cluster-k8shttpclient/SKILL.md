---
name: effect-facet-unstable-cluster-k8shttpclient
description: Guidance for facet `effect/unstable/cluster/K8sHttpClient` focused on APIs like layer, makeGetPods, and makeCreatePod. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/K8sHttpClient

## Owned scope

- Owns only `effect/unstable/cluster/K8sHttpClient`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/K8sHttpClient.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/K8sHttpClient.ts`
