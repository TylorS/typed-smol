---
name: effect-facet-unstable-http-etag
description: Guidance for facet `effect/unstable/http/Etag` focused on APIs like layer, Generator, and layerWeak. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/Etag

## Owned scope

- Owns only `effect/unstable/http/Etag`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/Etag.ts`.
...
- Facet source: `packages/effect/src/unstable/http/Etag.ts`
