---
name: effect-facet-unstable-http-httpserverrequest
description: Guidance for facet `effect/unstable/http/HttpServerRequest` focused on APIs like fromWeb, ParsedSearchParams, and toURL. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpServerRequest

## Owned scope

- Owns only `effect/unstable/http/HttpServerRequest`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpServerRequest.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpServerRequest.ts`
