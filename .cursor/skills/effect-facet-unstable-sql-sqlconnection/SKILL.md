---
name: effect-facet-unstable-sql-sqlconnection
description: Guidance for facet `effect/unstable/sql/SqlConnection` focused on APIs like Row, Acquirer, and Connection. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/sql/SqlConnection

## Owned scope

- Owns only `effect/unstable/sql/SqlConnection`.
- Parent module: `effect/unstable/sql`.
- Source anchor: `packages/effect/src/unstable/sql/SqlConnection.ts`.
...
- Facet source: `packages/effect/src/unstable/sql/SqlConnection.ts`
