---
name: effect-facet-unstable-ai-anthropicstructuredoutput
description: Guidance for facet `effect/unstable/ai/AnthropicStructuredOutput` focused on APIs like toCodecAnthropic. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/ai/AnthropicStructuredOutput

## Owned scope

- Owns only `effect/unstable/ai/AnthropicStructuredOutput`.
- Parent module: `effect/unstable/ai`.
- Source anchor: `packages/effect/src/unstable/ai/AnthropicStructuredOutput.ts`.
...
- Facet source: `packages/effect/src/unstable/ai/AnthropicStructuredOutput.ts`
