...
- Facet import: `effect/unstable/ai/AnthropicStructuredOutput`
- Parent module: `effect/unstable/ai`
- Facet skill: `effect-facet-unstable-ai-anthropicstructuredoutput`
- Source: `packages/effect/src/unstable/ai/AnthropicStructuredOutput.ts`
- Parent primary skill: `effect-module-unstable-ai`
