---
name: effect-facet-function-core
description: Guidance for facet `effect/Function#core` focused on APIs like SK, dual, and flip. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet Function#core

## Owned scope

- Owns only `effect/Function#core`.
- Parent module: `effect/Function`.

## What it is for

- pipe/dual/core function tools. Module-specific APIs and usage patterns for Effect programs.
...
- Keep work focused on the `core` concern for `effect/Function`.
