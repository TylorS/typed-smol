---
name: effect-facet-unstable-rpc-rpcschema
description: Guidance for facet `effect/unstable/rpc/RpcSchema` focused on APIs like getStreamSchemas, isStreamSchema, and Stream. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/rpc/RpcSchema

## Owned scope

- Owns only `effect/unstable/rpc/RpcSchema`.
- Parent module: `effect/unstable/rpc`.
- Source anchor: `packages/effect/src/unstable/rpc/RpcSchema.ts`.
...
- Facet source: `packages/effect/src/unstable/rpc/RpcSchema.ts`
