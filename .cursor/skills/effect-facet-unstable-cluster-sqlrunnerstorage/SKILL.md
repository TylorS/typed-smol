---
name: effect-facet-unstable-cluster-sqlrunnerstorage
description: Guidance for facet `effect/unstable/cluster/SqlRunnerStorage` focused on APIs like make, layer, and layerWith. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/SqlRunnerStorage

## Owned scope

- Owns only `effect/unstable/cluster/SqlRunnerStorage`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/SqlRunnerStorage.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/SqlRunnerStorage.ts`
