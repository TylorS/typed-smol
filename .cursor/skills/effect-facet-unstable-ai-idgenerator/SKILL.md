---
name: effect-facet-unstable-ai-idgenerator
description: Guidance for facet `effect/unstable/ai/IdGenerator` focused on APIs like make, layer, and Service. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/ai/IdGenerator

## Owned scope

- Owns only `effect/unstable/ai/IdGenerator`.
- Parent module: `effect/unstable/ai`.
- Source anchor: `packages/effect/src/unstable/ai/IdGenerator.ts`.
...
- Facet source: `packages/effect/src/unstable/ai/IdGenerator.ts`
