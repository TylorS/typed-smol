---
name: effect-facet-unstable-http-httpplatform
description: Guidance for facet `effect/unstable/http/HttpPlatform` focused on APIs like make, layer, and HttpPlatform. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpPlatform

## Owned scope

- Owns only `effect/unstable/http/HttpPlatform`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpPlatform.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpPlatform.ts`
