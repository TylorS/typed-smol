---
name: effect-facet-unstable-http-findmyway
description: Guidance for facet `effect/unstable/http/FindMyWay` focused on its core API surface. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/FindMyWay

## Owned scope

- Owns only `effect/unstable/http/FindMyWay`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/FindMyWay.ts`.
...
- Facet source: `packages/effect/src/unstable/http/FindMyWay.ts`
