---
name: effect-facet-unstable-cluster-runnerstorage
description: Guidance for facet `effect/unstable/cluster/RunnerStorage` focused on APIs like Encoded, makeMemory, and layerMemory. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/RunnerStorage

## Owned scope

- Owns only `effect/unstable/cluster/RunnerStorage`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/RunnerStorage.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/RunnerStorage.ts`
