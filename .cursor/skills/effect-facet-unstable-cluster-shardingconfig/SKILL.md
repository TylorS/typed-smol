---
name: effect-facet-unstable-cluster-shardingconfig
description: Guidance for facet `effect/unstable/cluster/ShardingConfig` focused on APIs like layer, layerFromEnv, and layerDefaults. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/ShardingConfig

## Owned scope

- Owns only `effect/unstable/cluster/ShardingConfig`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/ShardingConfig.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/ShardingConfig.ts`
