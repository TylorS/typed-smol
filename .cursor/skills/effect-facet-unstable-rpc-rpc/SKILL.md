---
name: effect-facet-unstable-rpc-rpc
description: Guidance for facet `effect/unstable/rpc/Rpc` focused on APIs like make, Services, and ServicesClient. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/rpc/Rpc

## Owned scope

- Owns only `effect/unstable/rpc/Rpc`.
- Parent module: `effect/unstable/rpc`.
- Source anchor: `packages/effect/src/unstable/rpc/Rpc.ts`.
...
- Facet source: `packages/effect/src/unstable/rpc/Rpc.ts`
