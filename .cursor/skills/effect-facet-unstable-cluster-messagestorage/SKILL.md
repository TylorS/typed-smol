---
name: effect-facet-unstable-cluster-messagestorage
description: Guidance for facet `effect/unstable/cluster/MessageStorage` focused on APIs like make, Encoded, and layerNoop. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/MessageStorage

## Owned scope

- Owns only `effect/unstable/cluster/MessageStorage`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/MessageStorage.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/MessageStorage.ts`
