...
- Owns only `effect/unstable/httpapi/HttpApiGroup`.
- Parent module: `effect/unstable/httpapi`.
- Source anchor: `packages/effect/src/unstable/httpapi/HttpApiGroup.ts`.
...
- Facet source: `packages/effect/src/unstable/httpapi/HttpApiGroup.ts`
