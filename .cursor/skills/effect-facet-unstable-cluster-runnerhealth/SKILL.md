---
name: effect-facet-unstable-cluster-runnerhealth
description: Guidance for facet `effect/unstable/cluster/RunnerHealth` focused on APIs like makeK8s, layerK8s, and makePing. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/RunnerHealth

## Owned scope

- Owns only `effect/unstable/cluster/RunnerHealth`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/RunnerHealth.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/RunnerHealth.ts`
