---
name: effect-facet-unstable-persistence-persistedqueue
description: Guidance for facet `effect/unstable/persistence/PersistedQueue` focused on APIs like make, layer, and makeFactory. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/persistence/PersistedQueue

## Owned scope

- Owns only `effect/unstable/persistence/PersistedQueue`.
- Parent module: `effect/unstable/persistence`.
- Source anchor: `packages/effect/src/unstable/persistence/PersistedQueue.ts`.
...
- Facet source: `packages/effect/src/unstable/persistence/PersistedQueue.ts`
