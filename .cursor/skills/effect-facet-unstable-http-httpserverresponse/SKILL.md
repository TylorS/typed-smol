---
name: effect-facet-unstable-http-httpserverresponse
description: Guidance for facet `effect/unstable/http/HttpServerResponse` focused on APIs like empty, fromWeb, and setBody. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpServerResponse

## Owned scope

- Owns only `effect/unstable/http/HttpServerResponse`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpServerResponse.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpServerResponse.ts`
