---
name: effect-facet-unstable-cluster-clustercron
description: Guidance for facet `effect/unstable/cluster/ClusterCron` focused on APIs like make. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/ClusterCron

## Owned scope

- Owns only `effect/unstable/cluster/ClusterCron`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/ClusterCron.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/ClusterCron.ts`
