---
name: effect-facet-unstable-cluster-clustererror
description: Guidance for facet `effect/unstable/cluster/ClusterError` focused on APIs like RunnerNotRegistered, RunnerUnavailable, and MailboxFull. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/ClusterError

## Owned scope

- Owns only `effect/unstable/cluster/ClusterError`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/ClusterError.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/ClusterError.ts`
