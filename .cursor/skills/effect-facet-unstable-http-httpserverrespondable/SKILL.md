---
name: effect-facet-unstable-http-httpserverrespondable
description: Guidance for facet `effect/unstable/http/HttpServerRespondable` focused on APIs like isRespondable, TypeId, and toResponse. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpServerRespondable

## Owned scope

- Owns only `effect/unstable/http/HttpServerRespondable`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpServerRespondable.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpServerRespondable.ts`
