---
name: effect-facet-unstable-rpc-utils
description: Guidance for facet `effect/unstable/rpc/Utils` focused on APIs like withRun. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/rpc/Utils

## Owned scope

- Owns only `effect/unstable/rpc/Utils`.
- Parent module: `effect/unstable/rpc`.
- Source anchor: `packages/effect/src/unstable/rpc/Utils.ts`.
...
- Facet source: `packages/effect/src/unstable/rpc/Utils.ts`
