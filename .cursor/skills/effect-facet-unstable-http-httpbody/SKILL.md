---
name: effect-facet-unstable-http-httpbody
description: Guidance for facet `effect/unstable/http/HttpBody` focused on APIs like empty, Empty, and isHttpBody. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpBody

## Owned scope

- Owns only `effect/unstable/http/HttpBody`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpBody.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpBody.ts`
