---
name: effect-facet-unstable-http-httprouter
description: Guidance for facet `effect/unstable/http/HttpRouter` focused on APIs like From, make, and Make. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/HttpRouter

## Owned scope

- Owns only `effect/unstable/http/HttpRouter`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/HttpRouter.ts`.
...
- Facet source: `packages/effect/src/unstable/http/HttpRouter.ts`
