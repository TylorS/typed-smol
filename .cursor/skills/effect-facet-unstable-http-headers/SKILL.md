---
name: effect-facet-unstable-http-headers
description: Guidance for facet `effect/unstable/http/Headers` focused on APIs like get, set, and empty. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/Headers

## Owned scope

- Owns only `effect/unstable/http/Headers`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/Headers.ts`.
...
- Facet source: `packages/effect/src/unstable/http/Headers.ts`
