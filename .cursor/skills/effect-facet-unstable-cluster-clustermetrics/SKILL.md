---
name: effect-facet-unstable-cluster-clustermetrics
description: Guidance for facet `effect/unstable/cluster/ClusterMetrics` focused on APIs like runners, runnersHealthy, and shards. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/ClusterMetrics

## Owned scope

- Owns only `effect/unstable/cluster/ClusterMetrics`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/ClusterMetrics.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/ClusterMetrics.ts`
