---
name: effect-facet-unstable-cluster-singletonaddress
description: Guidance for facet `effect/unstable/cluster/SingletonAddress` focused on APIs like SingletonAddress. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/SingletonAddress

## Owned scope

- Owns only `effect/unstable/cluster/SingletonAddress`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/SingletonAddress.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/SingletonAddress.ts`
