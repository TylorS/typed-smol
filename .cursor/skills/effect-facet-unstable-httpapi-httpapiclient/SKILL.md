---
name: effect-facet-unstable-httpapi-httpapiclient
description: Guidance for facet `effect/unstable/httpapi/HttpApiClient` focused on APIs like make, makeWith, and group. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/httpapi/HttpApiClient

## Owned scope

- Owns only `effect/unstable/httpapi/HttpApiClient`.
- Parent module: `effect/unstable/httpapi`.
- Source anchor: `packages/effect/src/unstable/httpapi/HttpApiClient.ts`.
...
- Facet source: `packages/effect/src/unstable/httpapi/HttpApiClient.ts`
