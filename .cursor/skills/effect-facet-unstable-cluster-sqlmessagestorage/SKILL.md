---
name: effect-facet-unstable-cluster-sqlmessagestorage
description: Guidance for facet `effect/unstable/cluster/SqlMessageStorage` focused on APIs like make, layer, and layerWith. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/SqlMessageStorage

## Owned scope

- Owns only `effect/unstable/cluster/SqlMessageStorage`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/SqlMessageStorage.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/SqlMessageStorage.ts`
