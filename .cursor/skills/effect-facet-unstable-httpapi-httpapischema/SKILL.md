---
name: effect-facet-unstable-httpapi-httpapischema
description: Guidance for facet `effect/unstable/httpapi/HttpApiSchema` focused on APIs like Empty, getPayloadEncoding, and getResponseEncoding. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/httpapi/HttpApiSchema

## Owned scope

- Owns only `effect/unstable/httpapi/HttpApiSchema`.
- Parent module: `effect/unstable/httpapi`.
- Source anchor: `packages/effect/src/unstable/httpapi/HttpApiSchema.ts`.
...
- Facet source: `packages/effect/src/unstable/httpapi/HttpApiSchema.ts`
