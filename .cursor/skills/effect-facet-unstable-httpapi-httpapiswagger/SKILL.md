---
name: effect-facet-unstable-httpapi-httpapiswagger
description: Guidance for facet `effect/unstable/httpapi/HttpApiSwagger` focused on APIs like layer. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/httpapi/HttpApiSwagger

## Owned scope

- Owns only `effect/unstable/httpapi/HttpApiSwagger`.
- Parent module: `effect/unstable/httpapi`.
- Source anchor: `packages/effect/src/unstable/httpapi/HttpApiSwagger.ts`.
...
- Facet source: `packages/effect/src/unstable/httpapi/HttpApiSwagger.ts`
