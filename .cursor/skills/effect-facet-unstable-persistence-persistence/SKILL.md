---
name: effect-facet-unstable-persistence-persistence
description: Guidance for facet `effect/unstable/persistence/Persistence` focused on APIs like layer, layerKvs, and layerSql. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/persistence/Persistence

## Owned scope

- Owns only `effect/unstable/persistence/Persistence`.
- Parent module: `effect/unstable/persistence`.
- Source anchor: `packages/effect/src/unstable/persistence/Persistence.ts`.
...
- Facet source: `packages/effect/src/unstable/persistence/Persistence.ts`
