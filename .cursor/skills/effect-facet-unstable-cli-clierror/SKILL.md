---
name: effect-facet-unstable-cli-clierror
description: Guidance for facet `effect/unstable/cli/CliError` focused on APIs like isCliError, CliError, and ShowHelp. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cli/CliError

## Owned scope

- Owns only `effect/unstable/cli/CliError`.
- Parent module: `effect/unstable/cli`.
- Source anchor: `packages/effect/src/unstable/cli/CliError.ts`.
...
- Facet source: `packages/effect/src/unstable/cli/CliError.ts`
