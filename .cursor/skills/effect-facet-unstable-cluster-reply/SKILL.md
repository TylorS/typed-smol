---
name: effect-facet-unstable-cluster-reply
description: Guidance for facet `effect/unstable/cluster/Reply` focused on APIs like Encoded, isReply, and Chunk. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/Reply

## Owned scope

- Owns only `effect/unstable/cluster/Reply`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/Reply.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/Reply.ts`
