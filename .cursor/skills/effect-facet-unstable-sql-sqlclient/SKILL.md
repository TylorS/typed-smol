---
name: effect-facet-unstable-sql-sqlclient
description: Guidance for facet `effect/unstable/sql/SqlClient` focused on APIs like make, MakeOptions, and makeWithTransaction. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/sql/SqlClient

## Owned scope

- Owns only `effect/unstable/sql/SqlClient`.
- Parent module: `effect/unstable/sql`.
- Source anchor: `packages/effect/src/unstable/sql/SqlClient.ts`.
...
- Facet source: `packages/effect/src/unstable/sql/SqlClient.ts`
