---
name: effect-facet-unstable-ai-mcpschema
description: Guidance for facet `effect/unstable/ai/McpSchema` focused on APIs like SetLevel, GetPrompt, and ParseError. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/ai/McpSchema

## Owned scope

- Owns only `effect/unstable/ai/McpSchema`.
- Parent module: `effect/unstable/ai`.
- Source anchor: `packages/effect/src/unstable/ai/McpSchema.ts`.
...
- Facet source: `packages/effect/src/unstable/ai/McpSchema.ts`
