---
name: effect-facet-unstable-http-multipasta
description: Guidance for facet `effect/unstable/http/Multipasta` focused on its core API surface. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http/Multipasta

## Owned scope

- Owns only `effect/unstable/http/Multipasta`.
- Parent module: `effect/unstable/http`.
- Source anchor: `packages/effect/src/unstable/http/Multipasta.ts`.
...
- Facet source: `packages/effect/src/unstable/http/Multipasta.ts`
