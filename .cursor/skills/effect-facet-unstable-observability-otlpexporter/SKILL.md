---
name: effect-facet-unstable-observability-otlpexporter
description: Guidance for facet `effect/unstable/observability/OtlpExporter` focused on APIs like make. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/observability/OtlpExporter

## Owned scope

- Owns only `effect/unstable/observability/OtlpExporter`.
- Parent module: `effect/unstable/observability`.
- Source anchor: `packages/effect/src/unstable/observability/OtlpExporter.ts`.
...
- Facet source: `packages/effect/src/unstable/observability/OtlpExporter.ts`
