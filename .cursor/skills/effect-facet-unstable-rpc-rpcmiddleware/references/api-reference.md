...
```ts
export declare const layerClient: <Id extends AnyId, S, R, EX = never, RX = never>(tag: Context.Service<Id, S>, service: RpcMiddlewareClient<Id[TypeId]["error"]["Type"], Id[TypeId]["clientError"], R> | Effect.Effect<RpcMiddlewareClient<Id[TypeId]["error"]["Type"], Id[TypeId]["clientError"], R>, EX, RX>): Layer.Layer<ForClient<Id>, EX, R | Exclude<RX, Scope>>;
