---
name: effect-facet-unstable-cluster-shardingregistrationevent
description: Guidance for facet `effect/unstable/cluster/ShardingRegistrationEvent` focused on APIs like EntityRegistered, ShardingRegistrationEvent, and SingletonRegistered. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/ShardingRegistrationEvent

## Owned scope

- Owns only `effect/unstable/cluster/ShardingRegistrationEvent`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/ShardingRegistrationEvent.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/ShardingRegistrationEvent.ts`
