---
name: effect-facet-unstable-cluster-entityaddress
description: Guidance for facet `effect/unstable/cluster/EntityAddress` focused on APIs like make and EntityAddress. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/cluster/EntityAddress

## Owned scope

- Owns only `effect/unstable/cluster/EntityAddress`.
- Parent module: `effect/unstable/cluster`.
- Source anchor: `packages/effect/src/unstable/cluster/EntityAddress.ts`.
...
- Facet source: `packages/effect/src/unstable/cluster/EntityAddress.ts`
