---
name: effect-facet-unstable-http-middleware
description: Guidance for facet `effect/unstable/http#middleware` focused on APIs like Headers, HttpMiddleware, and HttpTraceContext. Load after `effect-skill-router` when this facet is the primary owner.
---

# Effect Facet unstable/http#middleware

## Owned scope

- Owns only `effect/unstable/http#middleware`.
- Parent module: `effect/unstable/http`.

## What it is for

- middleware/effect/tracing glue. Module-specific APIs and usage patterns for Effect programs.
...
- Keep work focused on the `middleware` concern for `effect/unstable/http`.
